...
/***************************************************************************/ /**
 * Returns the most recent accel/gyro reading if new data has arrived since
 * the last call. Returns false (and leaves accel/gyro untouched) if no new
 * sample is available yet.
 ******************************************************************************/
bool icm40627_example_get_latest_data(float accel[3], float gyro[3]);
